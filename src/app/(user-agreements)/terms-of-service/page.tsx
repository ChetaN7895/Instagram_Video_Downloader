    ...
    <div className="my-4 flex flex-col rounded-lg border p-8">
      ...
      <section className="mb-2 text-sm">
        ...
        <p className="mb-2">
          ...
          <span className="text-gray-900 dark:text-gray-500">
            {" "}
            (https://instagram-video-downloader-mu.vercel.app/).
          </span>{" "}
      ...
      <section className="mb-2 text-sm">
        ...
        <p className="mb-2">
          ...
          <span className="italic">chetansolanki0003@gmail.com</span>.
        </p>
      </section>
      ...
      <section className="mb-2 text-sm">
        <p className="text-red-500">
          <span className="font-semibold">Disclaimer :</span> This is Made For User Concern 
        </p>
      </section>
    </div>
  );
